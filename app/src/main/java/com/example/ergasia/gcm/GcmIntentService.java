...
public class GcmIntentService extends IntentService {
    ...
    private void registerGCM() {
        ...
        try {
            ...
            sharedPreferences.edit().putBoolean(MessageConfig.SENT_TOKEN_TO_SERVER, false).apply();
        }
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    if (!obj.getBoolean("error")) {
                        ...
                        Toast.makeText(getApplicationContext(), "Unable to send gcm registration id to our server. " + obj.getJSONObject("error").getString("message"), Toast.LENGTH_LONG).show();
                    }
    ...
    public void unsubscribeFromTopic(String topic) {
        ...
        try {
            ...
            Toast.makeText(getApplicationContext(), "Topic unsubscribe error. Topic: " + topic + ", error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    }
}
