...
import com.example.ergasia.adapter.ChatRoomThreadAdapter;
...
public class ChatRoomActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        chatRoomId = intent.getStringExtra("chat_rooms_id");
    ...
    /**
     * Handling new push message, will add the message to recycler view
